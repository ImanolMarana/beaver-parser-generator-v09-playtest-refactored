...
public class GrammarScanner extends Scanner {
  ...
  public Symbol nextToken() throws java.io.IOException, Scanner.Exception {
        ...
        while (true) {
          ...
          yyline = adjustLineCount(zzBufferL, zzStartRead, zzMarkedPosL, yyline);
          ...
          switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
            ...
            case 2: {
              yybegin(YYINITIAL);
              matched_text = null;
              throw new Scanner.Exception(token_line + 1, token_column + 1, "unterminated string");
            }
            case 54:
              break;
            case 29: {
            ...
            case 22: {
              yybegin(YYINITIAL);
              String txt = matched_text;
              matched_text = null;
              return new Symbol(Terminals.TEXT, Symbol.makePosition(token_line + 1, token_column + 1), Symbol.makePosition(yyline + 1, yycolumn + 1), txt);
            }
            case 68:
              break;
            case 31: {
            ...
            case 27: {
              yybegin(YYINITIAL);
              return new Symbol(Terminals.CODE, Symbol.makePosition(token_line + 1, token_column + 1), Symbol.makePosition(yyline + 1, yycolumn + 3), matched_text);
            }
            case 71:
              break;
            case 20: {
      ...
      private int adjustLineCount(char[] buffer, int start, int end, int currentLine) {
