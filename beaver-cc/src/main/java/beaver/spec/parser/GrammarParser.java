	...
	protected Symbol invokeReduceAction(int rule_num, int offset) {
        switch(rule_num) {
          ...
          case 43: // lst$def_element = lst$def_element def_element
            return handleListReduction(rule_num, offset);
          case 6: // grammar = opt$lst$declaration.decl lst$rule.rules
            return handleGrammarReduction(offset);
          case 20: // declaration = error.e SEMI
            return handleDeclarationError(offset);
          ...
          case 28: // grammar_goal = GOAL IDENT.name SEMI
            return handleSimpleDeclaration(rule_num, offset);
      ...
      private Symbol handleListReduction(int rule_num, int offset) {
        switch (rule_num) {
          case 0:
          case 4:
          case 34:
          ...
          case 43:
            ...
            return _symbols[offset + 1];
          default: 
            throw new IllegalArgumentException("Invalid rule number for list reduction: " + rule_num);
        }
      }
      
      private Symbol handleGrammarReduction(int offset) {
      ...
      private Symbol handleDeclarationError(int offset) {
        final Symbol e = _symbols[offset + 1];
      
        log.error(e, "malformed declaration"); return new Declaration.Error();
      }
      
      private Symbol handleSimpleDeclaration(int rule_num, int offset) {
        final Symbol value = _symbols[offset + 2];
      
        switch (rule_num) {
          case 21: return new Declaration.Header(value);
          case 22: return new Declaration.PackageName(value);
          case 24: return new Declaration.ClassName(value);
          case 25: return new Declaration.ClassCode(value);
          case 26: return new Declaration.ConstructorCode(value);
          case 28: return new Declaration.Goal(value);
          default: throw new IllegalArgumentException("Invalid rule number for simple declaration: " + rule_num);
        }
      }
      
      private Symbol handleListDeclaration(int rule_num, int offset) {
        ...
        switch (rule_num) {
          case 23: return new Declaration.Imports(names);
          case 27: return new Declaration.Implements(names);
          case 29: return new Declaration.Terminals(names);
          case 30: return new Declaration.LeftAssoc(names);
          case 31: return new Declaration.RightAssoc(names);
          case 32: return new Declaration.NonAssoc(names);
          case 33: return new Declaration.TypeOf(names, _symbols[offset + 4]);
          default: throw new IllegalArgumentException("Invalid rule number for list declaration: " + rule_num);
        }
      }
      
      private Symbol handleRuleReduction(int offset) {
      ...
      private Symbol handleRuleError(int offset) {
        final Symbol e = _symbols[offset + 1];
      ...
      private Symbol handleDefinitionReduction(int offset) {
      ...
      private Symbol handleDefinitionError(int offset) {
        final Symbol e = _symbols[offset + 1];
      ...
      private Symbol handleDefElementReduction(int offset) {
        final Symbol name = _symbols[offset + 1];
