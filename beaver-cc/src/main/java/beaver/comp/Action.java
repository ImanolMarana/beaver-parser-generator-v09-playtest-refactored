	...
	static class List
	{
		...
		Action split(List terminal_actions, List nonterminal_actions)
      {
        ...
        for (Action act = first; act != null; act = act.next)
        {
          ...
          {
            addToRemovableActions(act);
          }
          else
          {
            handleNonRemovableAction(terminal_actions, nonterminal_actions, act, default_act);
          }
        }
      
        updateActionLists(terminal_actions, nonterminal_actions, first_not_used, last_not_used, default_act);
        return default_act;
      }
      
      private void addToRemovableActions(Action act) {
      ...
      private void handleNonRemovableAction(List terminal_actions, List nonterminal_actions, Action act, Action default_act) {
        ...
        {
          handleDefaultAction(default_act, act);
        }
      }
      
      private void handleDefaultAction(Action default_act, Action act) {
        if (default_act != null)
        {
      ...
      private void updateActionLists(List terminal_actions, List nonterminal_actions, Action first_not_used, Action last_not_used, Action default_act) {
